...
class AiosRoadmapsFinancing {
    public function __construct() {
        add_action('rest_api_init', array($this, 'register_endpoints'));
    }

    public function register_endpoints() {
        register_rest_route('aios-populate/v1', '/roadmaps-financing', array(
            'methods'   => 'POST',
    ...
    public function aios_populate_aios_roadmaps($data) {
        ...
        if (empty($financing)){
            ...
            $uploaders = new AiosRoadmapsFinancing();
            ...
            $response_data['message'] = 'Financing generated successfully.';
